...
import com.example.tutorial.entity.Session;
import com.example.tutorial.entity.User;
import com.example.tutorial.repository.SessionRepository;
...
public class SessionService {
    ...
    public void generateNewSession(User user, String refreshToken) {
        ...
        if (userSession.size() >= SESSION_LIMIT) {
            userSession.sort(Comparator.comparing(session -> session.getLastUsedAt()));
